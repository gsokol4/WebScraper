...
class WebsiteCrawler {
    ...
    async openBrowser(options = {}) {
        try {
            ...
            throw new Error("Could not open browser. Check Puppeteer installation or launch options.")
        }
    }

    async openNewPage() {
        try {
            if (!this.browser) throw new Error("Browser not started. Call openBrowser first.")
